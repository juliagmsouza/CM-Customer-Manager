<template>
  <validation-provider ref="provider" :rules="rules" :name="name" v-bind="$attrs" v-slot="{errors, valid, invalid, validated}">
    <b-form-group>
      <slot name="label">
  ...
  export default {
    ...
    data() {
      return {
        focused: false,
        errorMapper: {
          'The Email field must be a valid email': 'Insira um e-mail válido',
